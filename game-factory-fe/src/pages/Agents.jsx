...
import { Users, Plus, Brain, MessageSquare, Star, Play, Terminal, Cpu, RefreshCw, CheckCircle2 } from 'lucide-react';
...
export default function Agents() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const [agentsRes, gamesRes, reviewsRes] = await Promise.all([
                fetch('/api/agents'),
                fetch('/api/games'),
                fetch('/api/reviews')
            ]);
        ...
        <div style={{ padding: '32px', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '32px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto', gap: '16px', alignItems: 'flex-end' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '8px',
                                    fontWeight: 700,
                                    opacity: (isEvaluating || games.length === 0 || agents.length === 0) ? 0.5 : 1,
                                    cursor: 'pointer',
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '8px'
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <div key={agent.id} className="glass-panel" style={{ padding: '16px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ margin: 0, fontSize: '0.7rem', color: 'var(--text-muted)' }}>Status: DEPLOYED</p>
                                </div>
                            </div>
                    ...
                    {agents.length === 0 && (
                        <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', textAlign: 'center' }}>No agents deployed.</p>
                    )}
                </div>
            </div>
                        ...
                        <form onSubmit={handleCreateAgent}>
                            ...
                            <div style={{ marginBottom: '24px' }}>
                                ...
                                <textarea
                                    ...
                                    placeholder="Define how this agent should view the game. e.g. 'You are a harsh critic who values visual polish and sound design...'"
                                    style={{
                                        width: '100%',
                                        height: '150px',
                                        background: 'rgba(0,0,0,0.3)',
